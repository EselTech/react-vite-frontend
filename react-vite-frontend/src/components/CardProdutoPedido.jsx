        ...
        >
            <div className="h-24 flex px-4 items-center" onClick={handleCardClick}>
                ...
                <div className="flex-1 pl-4 flex flex-col justify-center">
                    <p className="font-bold text-[#3D2B4F] text-sm uppercase tracking-tight">{produto.nome}</p>
                    <p className="text-[10px] text-[#7a6688] font-bold uppercase">Unitário: R$ {produto.preco}</p>
                </div>
