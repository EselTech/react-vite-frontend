export function BotaoNav(props) {
    ...
    const estiloAtivo = "w-[90%] -ml-4 pl-4 rounded-full flex items-center gap-2 justify-self-start font-medium font-title text-[#D9D9D9] h-[5vh] text-1 cursor-pointer bg-[linear-gradient(90deg,rgba(105,80,136,1)_0%,rgba(194,162,229,1)_100%)]"
